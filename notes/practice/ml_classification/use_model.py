...
new_pred = local_classifier.predict(local_scaler.transform(np.array([[40,50000]])))
new_pred_proba = local_classifier.predict_proba(local_scaler.transform(np.array([[40,50000]])))[:,1]